...
<CardGroup cols={2}>
    ...
    <Card title="Next.js Example" icon="arrow-up-right-from-square" href="https://github.com/fapiper/krono/tree/main/apps/web">
...
<CardGroup cols={2}>
    ...
    <Card title="Configuration" icon="gear" href="/kit/configuration/overview">
    ...
    <Card title="Providers" icon="layer-group" href="/hooks/providers/orderbook-provider">
